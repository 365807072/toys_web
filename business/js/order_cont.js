	...
	success:function(data){
		...
		data_Index=v_data.package;
			...
			if(payStates==1){
				...
				$(".form").on("click","#s_btn",function(){
					window.location.href="http://www.meimei.yihaoss.top/business/pay.html?login_user_id="+login_userId+"&business_id="+business_Id+"&package="+data_Index+"&order_rol=0&code="+code+"&open_id="+openid;
				})
			}
			else if(payStates==3){
				typeName="已完成";
