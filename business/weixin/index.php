...
<body>
	<div align="center">
        <ul>
        <!-- open_id=ouLbysxoFrsmY0b4qGexDjuVwwXQ -->
           <!--  <li style="background-color:#FF7F24"><a href='http://www.meimei.yihaoss.top/weixin/js/jsapi.php?business_title=测试数据&order_id=700&price=1&code=021RZ1HW0wSmSP1vT6KW0RJ0HW0RZ1Hx&open_id=ouLbysxoFrsmY0b4qGexDjuVwwXQ '>JSAPI支付</a></li> -->
           <li style="background-color:#8B6914"><a href="http://www.meimei.yihaoss.top/business/weixin/native.php">扫码支付</a></li>
            <li style="background-color:#FF7F24"><a href="http://www.meimei.yihaoss.top/business/weixin/money.php">扫商户码支付jsapi</a></li>
            <!-- <li style="background-color:#8B6914"><a href="http://www.meimei.yihaoss.top/business/weixin/code/native.php">扫码支付</a></li> -->
            
            <!-- ouLbysz4MgP2-fLPlFED_u5Oyc1w -->
