...
if(isset($_REQUEST["money"]) && $_REQUEST["money"] != ""){
	...
	$insertsql ="insert into baby_order (seller_id,order_num,state,create_time,post_create_time,order_time,payment,number,price,status,business_id,need_price,address) 
	...
	$input->SetNotify_url("http://www.meimei.yihaoss.top/business/weixin/notify.php");//http://paysdk.weixin.qq.com/example/notify.php
...
<body style="background:#f5f5f5;">
	...
	<form action="#" method="post">
        ...
        <input type="text" style="width:100%;height0.98rem;margin-top:0.2rem;background:#fff;border:none;border-bottom:0.5px solid #e4e4e4;line-height:0.98rem;padding-left:0.2rem;" name="money" id="money" placeholder="输入需要支付的金额" />
		<div align="center">
