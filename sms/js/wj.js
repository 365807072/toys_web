$(function(){
	...
	$('.main').dropload({
	    ...
	    loadUpFn : function(me){
	        ...
	        $.ajax({
	            type: 'GET',
	            url: 'http://api.baobaoshowshow.com/index.php?r=BabyShowV1/webGroupListingPage&login_user_id=287138&group_id=658',
	            dataType: 'json',
	    ...
	    loadDownFn : function(me){
	        ...
	        $.ajax({
	            type: 'GET',
	            url: 'http://api.baobaoshowshow.com/index.php?r=BabyShowV1/webGroupListingPage&login_user_id=287138&group_id=658&post_create_time='+time,
	            dataType: 'json',
	            success: function(data){
					groupList=data.data;
	...
	$(".wrapper").on("click",".content",function(){
		...
		if(String(groupList[index].video_url) == ""){
			window.location.href='http://www.meimei.yihaoss.top/sms/fx.html?img_id='+groupList[parseInt(index)].img[0].img_id+'&user_id='+userId;
		}else{
			window.location.href='http://www.meimei.yihaoss.top/sms/fxvideo.html?user_id='+userId+'&img_id='+groupList[parseInt(index)].img[0].img_id;
		};
		if(String(groupList[index].business_id)){
		...
		if(String(groupList[index].post_url)){
