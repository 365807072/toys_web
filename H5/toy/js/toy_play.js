$(function(){
	...
	var itemindex = url[2].substring(url[2].indexOf("=")+1);
	...
	$.ajax({
		...
		success:function(data){
            ...
            aStr=aStr.replace(/\r\n/g,"<br>"); 
			boxhtml='<p><span><img src="img/safe.png"></span><span>'+detailData.support_name+'</span></p><p>'+aStr+'</p>';
			$('.box').html(boxhtml);
	...
	$(".left").on("click",function(){
		...
		window.location.href='http://www.meimei.yihaoss.top/H5/toy/toy_home.html?login_user_id='+userId+'&itemIndex='+itemindex;
	})
}) 