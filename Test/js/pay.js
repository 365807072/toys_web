                ...
                isClick=false;
                  if(price==0){ 
                      $.ajax({
                          ...
                          type:'GET',
                          success:function(data){
                              window.location.href="http://www.meimei.yihaoss.top/Test/order.html?login_user_id="+login_userId;
                          },
                      ...
                      $.ajax({
                          url:'http://www.meimei.yihaoss.top/Test/weixin/jsapi/jsapi.php?business_title='+business_title+'&order_id='+order_id+'&price='+price+'&code='+code+'&open_id='+openid,
                          type:'GET',
                          success:function(data){
...
$(".l_btn").on("click",function(){
      ...
      window.location.href='http://www.meimei.yihaoss.top/Test/business_details.html?login_user_id='+login_userId+'&business_id='+business_id;
})
