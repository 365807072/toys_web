...
<?php 
		...
		//获取相册
			$descSql = "select id,album_name,tag_name,album_description from baby_diary_album where user_id={$user_id} and baby_id={$baby_id} and state='0' order by dyear asc,dmonth asc,dday asc";
			//echo $descSql;exit;
                ...
                <div class='info abs'>
                   ...
                   <a href='../share_diary.php?user_id={$user_id}&baby_id={$baby_id}&album_id={$value['id']}'>
                    ...
                    <div class='cell keyframe-wrap'>
                        ...
                        <div class='keyframe'>{$value['tag_name']}<div class='comment'>{$value['album_name']}</div></div>
                    </div>
                </div>
            </section>
			";
					...
					echo " <section class='list list-e'>
            <div class='flag-wrap'>
                <div class='flag'>
                    {$value['album_name']}
                    <span class='arrow'></span>
